...
class Capture:
    ...
    Attributes:
        packet_summary (list): A list to store summary information of captured
                               packets.
    ...
    Methods:
        add_packet_to_buffer(packet): Static method to add packet information
                                      to the summary buffer.
        is_empty: Property method to check if the packet summary is empty.
        packet_num_packet_captured: Property method to get the number
                                    of packets captured.
